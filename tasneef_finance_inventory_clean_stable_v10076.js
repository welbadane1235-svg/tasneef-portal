...
/* ===== tasneef_finance_inventory_stable_root_v10070.js merged into clean stable v10076 ===== */
(function(){
  'use strict';
...
/* ===== tasneef_finance_inventory_stable_root_v10073.js merged into clean stable v10076 ===== */
...
/* ===== tasneef_finance_inventory_fast_products_print_v10075.js merged into clean stable v10076 ===== */
...
/* ===== v10076 hard stabilization layer ===== */
(function(){
  'use strict';
  window.__tasneefFinanceInventoryCleanStableV10076 = true;
  ...
  window.tasneefFinanceClearDraftInvoiceV10076 = function(){
    try{
  ...
  function addClearButton(){
    try{
      ...
      if(dash.querySelector('#tasneefClearDraftInvoiceV10076')) return;
      var box=document.createElement('div');
      box.className='msg';
      box.style.margin='8px 0';
      box.innerHTML='<b>وضع الثبات v10076:</b> تشغيل ثابت بدون تحديث تلقائي. <button id="tasneefClearDraftInvoiceV10076" class="light" type="button">تفريغ الفاتورة المعلقة</button>';
      ...
      box.querySelector('button').onclick=window.tasneefFinanceClearDraftInvoiceV10076;
    }catch(e){}
  }
