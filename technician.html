...
<div class="tech-shell">
  ...
  <nav class="tech-main-tabs no-print">
    ...
    <button class="tech-main-tab" onclick="showTechMainTab('techAdminTasksTab',this); if(window.TasneefFieldAdminTasksV10130) window.TasneefFieldAdminTasksV10130.open('technician')">مهام إدارية</button>
  ...
  <section id="techAdminTasksTab" class="tech-main-page">
    <section class="card">
      <h2>مهام إدارية</h2>
      <p>المهام المرسلة لك أو التي أنشأتها تظهر هنا مباشرة من Supabase.</p>
      <div id="techAdminTasksContent"></div>
    </section>
  </section>
    ...
    <div id="techAttendancePrintArea">
      <div class="card tech-att-card">
        ...
        <div class="grid two no-print">
          ...
          <div><label>تاريخ التحضير</label><input id="techAttendanceDate" type="date"></div>
...
(function(){
  ...
  async function saveToday(status){
    ...
    const date=$id('techAttendanceDate')?.value||todayISO();
  ...
  window.initTechnician=async function(){
    ...
    if($id('techAttendanceMonth') && !$id('techAttendanceMonth').value) $id('techAttendanceMonth').value=monthNow();
    if($id('techAttendanceDate') && !$id('techAttendanceDate').value) $id('techAttendanceDate').value=todayISO();
    renderTechAttendance();
  };
})();
</script>
...
<script src="tasneef_attendance_server_sync_v10003.js?v=10003"></script>
<script src="tasneef_field_admin_tasks_v10130.js?v=10130" defer></script>
<script src="tasneef_language_switcher_safe_v10134.js?v=10134" defer></script>
</body>
</html>
