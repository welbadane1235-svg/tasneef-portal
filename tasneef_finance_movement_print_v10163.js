...
(function(){
  ...
  const VERSION='v10162-finance-voucher-product-type-totals-design';
  ...
  function printRows(selectedOnly){
    ...
    const operationNo=systemOperationNo(rows);
      ...
      *{box-sizing:border-box}
      ...
      <div class="logo-wrap" style="margin-bottom:12px;justify-content:space-between">
        <div class="meta" style="flex:1;margin:0 0 0 12px">
          ...
          ${isIn?`<div class="stat"><small>رقم العملية في النظام</small><b>${esc(operationNo)}</b></div>`:''}
        </div>
