...
(function(){
  'use strict';
  if(window.__tasneefMonthlyRebuildV10199) return;
  window.__tasneefMonthlyRebuildV10199 = true;
  ...
  console.log('Tasneef V10199 monthly rebuilt buttons fixed loaded');
})();
