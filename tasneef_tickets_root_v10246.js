...
(function(){
  ...
  function ensureStyle(){
    ...
    const st=document.createElement('style'); st.id='tasneefTicketRootStyleV10246'; st.textContent=`
      ...
      .ticket-root-v10246-version{font-size:12px;color:#0b5d49;font-weight:900;align-self:center}.smart-ticket-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:12px;align-items:stretch}.smart-ticket-card{border:1px solid #dbe9e4;border-radius:14px;padding:0 12px 12px;background:white;box-shadow:0 4px 14px rgba(0,0,0,.04);overflow:hidden;display:flex;flex-direction:column;min-height:100%}.smart-ticket-top,.smart-ticket-meta,.smart-ticket-mini,.smart-ticket-actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:space-between}.smart-ticket-top.ticket-fixed-bar-v10372{position:sticky;top:0;z-index:4;margin:0 -12px 12px;padding:11px 12px;background:#123f31;color:#fff;border-bottom:1px solid rgba(255,255,255,.18);box-shadow:0 4px 12px rgba(4,45,34,.15);align-items:center}.smart-ticket-top.ticket-fixed-bar-v10372 strong{color:#fff!important;font-size:15px}.smart-ticket-top.ticket-fixed-bar-v10372 small{color:#d8eee7!important}.ticket-sla-card.late .ticket-fixed-bar-v10372{background:#a92f2f}.ticket-sla-card.near .ticket-fixed-bar-v10372{background:#9a6800}.ticket-sla-card.standard .ticket-fixed-bar-v10372,.ticket-sla-card.done .ticket-fixed-bar-v10372{background:#0c6a45}.smart-ticket-status{border-radius:20px;padding:5px 10px;border:1px solid rgba(255,255,255,.55);box-shadow:0 2px 6px rgba(0,0,0,.08)}.smart-ticket-status.green{background:#e7f8ed;color:#07622a}.smart-ticket-status.red{background:#ffecec;color:#b00020}.smart-ticket-status.amber{background:#fff6db;color:#7a4b00}.smart-ticket-note,.smart-ticket-card p{background:#f5faf8;border-radius:10px;padding:8px}.smart-ticket-actions{position:sticky;bottom:0;margin-top:auto;padding-top:10px;background:#fff;border-top:1px solid #edf3ef}.smart-ticket-actions button{margin:2px}
